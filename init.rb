if config.respond_to?(:gems)
  ...
  config.gem 'stffn-declarative_authorization', :lib => 'declarative_authorization', :version => '>=0.3.0', :source => 'http://gems.github.com'
  config.gem 'state_machine', :lib => 'state_machine', :version => '>=0.7.6', :source => "http://gems.rubyforge.org"
else
  begin
    require 'authlogic'
